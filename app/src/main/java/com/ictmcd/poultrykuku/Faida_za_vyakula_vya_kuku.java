...
public class Faida_za_vyakula_vya_kuku extends YouTubeBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_faida_za_vyakula_vya_kuku);
            ...
            youTubePlayerView.initialize("AIzaSyDUtGSne6oDOYHkr9pFmT39JBI9_C-BUEM",
                    new YouTubePlayer.OnInitializedListener() {
                        ...
                        public void onInitializationSuccess(YouTubePlayer.Provider provider,
                            ...
                            youTubePlayer.loadVideo("xz6gH761H6U");
                        }
